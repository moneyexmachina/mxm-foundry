...
- `FS008` — single MXM package directory exists under src/mxm  
- `FS009` — package py.typed exists in src/mxm/<package>  

- `FS010` — CHANGELOG.md exists  

- `FS011` — src/mxm is a namespace package root (no `__init__.py`)  
...
- `PY004` — Poetry package includes mxm namespace from src
...
- `PY010` — src/mxm/<package> matches Poetry distribution name  
